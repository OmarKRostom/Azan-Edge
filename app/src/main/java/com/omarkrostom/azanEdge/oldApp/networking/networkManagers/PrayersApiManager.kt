package com.omarkrostom.azanEdge.oldApp.networking.networkManagers

import com.omarkrostom.azanEdge.oldApp.Config
import com.omarkrostom.azanEdge.oldApp.Constants
import com.omarkrostom.azanEdge.oldApp.networking.apiServices.AzanRetrofitInterface
...
object PrayersApiManager {
    ...
    fun getPrayerTimesFromApi(longitude: String,
                              ...
                              onError: (String) -> Unit) {
        val prayerAzanRetrofitInterface = NetworkFactory.getRetrofitServiceInstance(Config.PRAYER_TIMES_API,
    ...
    fun getLocationFormattedAddress(longitude: String,
        ...
        val getFormattedAddressInstance = NetworkFactory.getRetrofitServiceInstance(Config.GOOGLE_MAPS_API,
                AzanRetrofitInterface::class.java
        )
